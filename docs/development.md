...
This guide contains information to help onboard developers to work on the [Joomla](https://joomlacms.org/) integration, hereafter referred to as "the plugin".
